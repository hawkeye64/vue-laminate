...
You can contribute to the content on the Vue Laminate site in a few different ways. Choose the way that works best for you.
...
Alternatively, you can fork the Vue Laminate repo, make your changes and generate a Pull Request.
...
Please keep this in mind when writing content for Vue Laminate:
